...
public class Color2 {
    ...
    public static void main(String[] args) throws IOException {
        BufferedImage img = ImageIO.read(new File("/Users/hewie/IdeaProjects/home/D25A8323.jpg"));
        CMap result = Color2.computeMap(img, 10);
        Iterator<DenormalizedVBox> boxes = result.getBoxes().iterator();
        while (boxes.hasNext()) {
            Color2.DenormalizedVBox denormalizedVBox = (Color2.DenormalizedVBox) boxes.next();
