...
public class ColorUtil2 {
    ...
    public static String getColor(MultipartFile multipartFile) throws IOException {
//        BufferedImage img = ImageIO.read(convertMultipartFileToFile(multipartFile));
//        CMap result = ColorUtil2.computeMap(img, 2);
//        Iterator<DenormalizedVBox> boxes = result.getBoxes().iterator();
        String res = "rgb(0, 0, 0)";
//        if (boxes.hasNext()) {
//            ColorUtil2.DenormalizedVBox denormalizedVBox = (ColorUtil2.DenormalizedVBox) boxes.next();
